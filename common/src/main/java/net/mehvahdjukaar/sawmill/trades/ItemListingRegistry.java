...
public class ItemListingRegistry extends SimpleJsonResourceReloadListener {
    ...
    protected void apply(Map<ResourceLocation, JsonElement> jsons, ResourceManager resourceManager, ProfilerFiller profiler) {
        ...
        for (var e : jsons.entrySet()) {
            ...
            var id = e.getKey();
            try {
                var targetId = SawmillMod.res("carpenter");
                var profession = Registry.VILLAGER_PROFESSION.getOptional(targetId);
                ...
                var entityType = Registry.ENTITY_TYPE.getOptional(targetId);
